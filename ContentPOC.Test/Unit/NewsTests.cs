...
namespace ContentPOC.Test.Unit
{
    public class NewsTests
    {
        ...
        public void WhenHeadinlineGettingUrl_ShouldReturnHashCode() =>
            _news.Children[0].Meta.Href.Should().Be("news/headlines/A357D733");

        [Fact]
        public void WhenSummaryGettingUrl_ShouldReturnHashCode() =>
            _news.Children[1].Meta.Href.Should().Be("news/story-summaries/A357D733");

        [Fact]
        public void WhenStoryGettingUrl_ShouldReturnHashCode() =>
            _news.Children[2].Meta.Href.Should().Be("news/story-text/A357D733");
    }
}